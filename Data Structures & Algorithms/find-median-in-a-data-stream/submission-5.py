...
class MedianFinder:
    ...
    #find median time complexity is always O (1) no matter the method

    # addnum time complexity decrease from O(nlon n) to O(log n) when using heap approeach due to eliminateion of sorting, log n is from heap operations
